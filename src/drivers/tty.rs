...
macro_rules! print {
    (($fg:expr, $bg:expr), $($arg:tt)*) => {
        $crate::drivers::tty::_print_color($fg, $bg, format_args!($($arg)*));
    };
    ($($arg:tt)*) => {
...
/// Prints with color using a global WRITER
#[doc(hidden)]
pub fn _print_color(fg: Color, bg: Color, args: fmt::Arguments) {
    ...
    interrupts::without_interrupts(|| {
        WRITER.lock().with_color(fg, bg, |writer| {
